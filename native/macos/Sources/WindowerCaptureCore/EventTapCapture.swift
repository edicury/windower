...
public final class EventTapSource {
    ...
    private func installMouseTap() {
        ...
        guard
            ...
            logStderr("windower-capture-macos: failed to create mouse/cursor CGEventTap for session \(sessionId)")
            return
        }
    ...
    private func installKeyTap() {
        ...
        guard
            ...
            logStderr("windower-capture-macos: failed to create keyboard CGEventTap for session \(sessionId) (secure input or missing Accessibility grant)")
